...
func (x *PersistentStorage) GetGcs() *GcsPersistentStore {
	if x != nil {
		return x.Gcs
	}
	return nil
...
func (x *PersistentStorage) GetAzs() *AzsPersistentStore {
	if x != nil {
		return x.Azs
	}
	return nil
...
func (x *PersistentStorage) GetOracle() *OraclePersistentStore {
	if x != nil {
		return x.Oracle
	}
	return nil
...
var file_storage_persistent_storage_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x12, 0x05, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x11, 0x73, 0x74, 0x6f, 0x72, 0x61,
	0x67, 0x65, 0x2f, 0x61, 0x7a, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x11, 0x73, 0x74,
	0x6f, 0x72, 0x61, 0x67, 0x65, 0x2f, 0x67, 0x63, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a,
	0x14, 0x73, 0x74, 0x6f, 0x72, 0x61, 0x67, 0x65, 0x2f, 0x6f, 0x72, 0x61, 0x63, 0x6c, 0x65, 0x2e,
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xa3, 0x01, 0x0a, 0x11, 0x50, 0x65, 0x72, 0x73, 0x69, 0x73,
	0x74, 0x65, 0x6e, 0x74, 0x53, 0x74, 0x6f, 0x72, 0x61, 0x67, 0x65, 0x12, 0x2b, 0x0a, 0x03, 0x67,
	...
	0x6f, 0x72, 0x65, 0x52, 0x06, 0x6f, 0x72, 0x61, 0x63, 0x6c, 0x65, 0x42, 0x2f, 0x5a, 0x2d, 0x67,
	...
	0x69, 0x65, 0x6e, 0x74, 0x2f, 0x73, 0x74, 0x6f, 0x72, 0x61, 0x67, 0x65, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}
...
var file_storage_persistent_storage_proto_goTypes = []interface{}{
	(*PersistentStorage)(nil),     // 0: proto.PersistentStorage
	(*GcsPersistentStore)(nil),    // 1: proto.GcsPersistentStore
	(*AzsPersistentStore)(nil),    // 2: proto.AzsPersistentStore
	(*OraclePersistentStore)(nil), // 3: proto.OraclePersistentStore
}
var file_storage_persistent_storage_proto_depIdxs = []int32{
	1, // 0: proto.PersistentStorage.gcs:type_name -> proto.GcsPersistentStore
	2, // 1: proto.PersistentStorage.azs:type_name -> proto.AzsPersistentStore
	3, // 2: proto.PersistentStorage.oracle:type_name -> proto.OraclePersistentStore
