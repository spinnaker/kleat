...
var file_security_authn_authn_proto_rawDesc = []byte{
	...
	0x65, 0x72, 0x6e, 0x61, 0x6d, 0x65, 0x22, 0xd0, 0x06, 0x0a, 0x04, 0x53, 0x61, 0x6d, 0x6c, 0x12,
	...
	,
	...
	0x72, 0x6f, 0x6c, 0x65, 0x73, 0x12, 0x26, 0x0a, 0x0e, 0x72, 0x6f, 0x6c, 0x65, 0x73, 0x44, 0x65,
	0x6c, 0x69, 0x6d, 0x69, 0x74, 0x65, 0x72, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0e, 0x72,
	0x6f, 0x6c, 0x65, 0x73, 0x44, 0x65, 0x6c, 0x69, 0x6d, 0x69, 0x74, 0x65, 0x72, 0x12, 0x1a, 0x0a,
	...
	0x68, 0x0a, 0x0f, 0x53, 0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x44, 0x69, 0x67, 0x65,
	0x73, 0x74, 0x12, 0x0f, 0x0a, 0x0b, 0x55, 0x4e, 0x53, 0x50, 0x45, 0x43, 0x49, 0x46, 0x49, 0x45,
	0x44, 0x10, 0x00, 0x12, 0x08, 0x0a, 0x04, 0x53, 0x48, 0x41, 0x31, 0x10, 0x01, 0x12, 0x0a, 0x0a,
	0x06, 0x53, 0x48, 0x41, 0x32, 0x35, 0x36, 0x10, 0x02, 0x12, 0x0a, 0x0a, 0x06, 0x53, 0x48, 0x41,
	0x33, 0x38, 0x34, 0x10, 0x03, 0x12, 0x0a, 0x0a, 0x06, 0x53, 0x48, 0x41, 0x35, 0x31, 0x32, 0x10,
	0x04, 0x12, 0x0d, 0x0a, 0x09, 0x52, 0x49, 0x50, 0x45, 0x4d, 0x44, 0x31, 0x36, 0x30, 0x10, 0x05,
	0x12, 0x07, 0x0a, 0x03, 0x4d, 0x44, 0x35, 0x10, 0x06, 0x22, 0xba, 0x02, 0x0a, 0x04, 0x4c, 0x64,
...
var file_security_authn_authn_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
...
var file_security_authn_authn_proto_goTypes = []interface{}{
	...
	(Saml_SignatureDigest)(0),              // 1: proto.security.authn.Saml.SignatureDigest
	(*Authentication)(nil),                 // 2: proto.security.authn.Authentication
	(*OAuth2)(nil),                         // 3: proto.security.authn.OAuth2
	(*OAuth2Client)(nil),                   // 4: proto.security.authn.OAuth2Client
	(*OAuth2Resource)(nil),                 // 5: proto.security.authn.OAuth2Resource
	(*OAuth2UserInfoMapping)(nil),          // 6: proto.security.authn.OAuth2UserInfoMapping
	(*Saml)(nil),                           // 7: proto.security.authn.Saml
	(*Ldap)(nil),                           // 8: proto.security.authn.Ldap
	(*X509)(nil),                           // 9: proto.security.authn.X509
	(*Iap)(nil),                            // 10: proto.security.authn.Iap
	(*Basic)(nil),                          // 11: proto.security.authn.Basic
	(*UsernamePassword)(nil),               // 12: proto.security.authn.UsernamePassword
	nil,                                    // 13: proto.security.authn.OAuth2.UserInfoRequirementsEntry
	(*Saml_UserAttributes)(nil),            // 14: proto.security.authn.Saml.UserAttributes
	(*wrappers.BoolValue)(nil),             // 15: google.protobuf.BoolValue
}
var file_security_authn_authn_proto_depIdxs = []int32{
	15, // 0: proto.security.authn.Authentication.enabled:type_name -> google.protobuf.BoolValue
	3,  // 1: proto.security.authn.Authentication.oauth2:type_name -> proto.security.authn.OAuth2
	7,  // 2: proto.security.authn.Authentication.saml:type_name -> proto.security.authn.Saml
	8,  // 3: proto.security.authn.Authentication.ldap:type_name -> proto.security.authn.Ldap
	9,  // 4: proto.security.authn.Authentication.x509:type_name -> proto.security.authn.X509
	10, // 5: proto.security.authn.Authentication.iap:type_name -> proto.security.authn.Iap
	11, // 6: proto.security.authn.Authentication.basic:type_name -> proto.security.authn.Basic
	15, // 7: proto.security.authn.OAuth2.enabled:type_name -> google.protobuf.BoolValue
	4,  // 8: proto.security.authn.OAuth2.client:type_name -> proto.security.authn.OAuth2Client
	13, // 9: proto.security.authn.OAuth2.userInfoRequirements:type_name -> proto.security.authn.OAuth2.UserInfoRequirementsEntry
	5,  // 10: proto.security.authn.OAuth2.resource:type_name -> proto.security.authn.OAuth2Resource
	6,  // 11: proto.security.authn.OAuth2.userInfoMapping:type_name -> proto.security.authn.OAuth2UserInfoMapping
	...
	15, // 13: proto.security.authn.OAuth2Client.useCurrentUri:type_name -> google.protobuf.BoolValue
	15, // 14: proto.security.authn.Saml.enabled:type_name -> google.protobuf.BoolValue
	14, // 15: proto.security.authn.Saml.userAttributeMapping:type_name -> proto.security.authn.Saml.UserAttributes
	1,  // 16: proto.security.authn.Saml.signatureDigest:type_name -> proto.security.authn.Saml.SignatureDigest
	15, // 17: proto.security.authn.Ldap.enabled:type_name -> google.protobuf.BoolValue
	15, // 18: proto.security.authn.X509.enabled:type_name -> google.protobuf.BoolValue
	15, // 19: proto.security.authn.Iap.enabled:type_name -> google.protobuf.BoolValue
	15, // 20: proto.security.authn.Basic.enabled:type_name -> google.protobuf.BoolValue
	12, // 21: proto.security.authn.Basic.user:type_name -> proto.security.authn.UsernamePassword
