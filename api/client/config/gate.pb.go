...
var file_config_gate_proto_rawDesc = []byte{
	...
	0x49, 0x61, 0x70, 0x52, 0x03, 0x69, 0x61, 0x70, 0x22, 0x40, 0x0a, 0x0e, 0x53, 0x70, 0x72, 0x69,
	...
	0x68, 0x32, 0x52, 0x06, 0x6f, 0x61, 0x75, 0x74, 0x68, 0x32, 0x22, 0x38, 0x0a, 0x0c, 0x53, 0x65,
...
var file_config_gate_proto_goTypes = []interface{}{
	...
	(*security.ApiSsl)(nil),   // 9: proto.security.ApiSsl
	(*security.Iap)(nil),      // 10: proto.security.Iap
}
var file_config_gate_proto_depIdxs = []int32{
	...
	9,  // 8: proto.config.ServerConfig.ssl:type_name -> proto.security.ApiSsl
	10, // 9: proto.config.Gate.GoogleConfig.iap:type_name -> proto.security.Iap
