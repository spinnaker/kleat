...
type Orca_Services struct {
	...
	Keel *ServiceSettings `protobuf:"bytes,2,opt,name=keel,proto3" json:"keel,omitempty"`
}
...
func (x *Orca_Services) GetKeel() *ServiceSettings {
	if x != nil {
		return x.Keel
	}
	return nil
...
var file_config_orca_proto_rawDesc = []byte{
	...
	0x73, 0x1a, 0x76, 0x0a, 0x08, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x12, 0x37, 0x0a,
	...
	0x61, 0x79, 0x65, 0x6e, 0x74, 0x61, 0x12, 0x31, 0x0a, 0x04, 0x6b, 0x65, 0x65, 0x6c, 0x18, 0x02,
	...
	0x6e, 0x67, 0x73, 0x52, 0x04, 0x6b, 0x65, 0x65, 0x6c, 0x1a, 0x49, 0x0a, 0x11, 0x50, 0x69, 0x70,
...
var file_config_orca_proto_depIdxs = []int32{
	...
	8,  // 6: proto.config.Orca.Services.keel:type_name -> proto.config.ServiceSettings
